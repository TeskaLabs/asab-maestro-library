...
cleanup() {
	rm -f ${TEMPFILE} /var/cache/*.etag-new
	rm -rf /webroot/*-new
}
...
install() {
	...
	curl --silent --show-error \
		...
		--etag-save /var/cache/$1.etag-new \
		--etag-compare /var/cache/$1.etag \
	...
	mv /var/cache/$1.etag-new /var/cache/$1.etag
